  ...
  Future<Map> getGif() async {
    ...
    if (busca == null || busca.isEmpty) {
      response = await http.get(
          "https://api.giphy.com/v1/gifs/trending?api_key=bczzcF9IoUKjIjQiB2O1VxCrNFcs6Ue9&limit=25&rating=g");
    } else {
      response = await http.get(
          "https://api.giphy.com/v1/gifs/search?api_key=bczzcF9IoUKjIjQiB2O1VxCrNFcs6Ue9&q=$busca&limit=19&offset=$offSet&rating=g&lang=pt");
    }
